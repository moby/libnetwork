...
type NetworkEvent struct {
	...
	// Current Epoch ID of the network on the originating node. In swarm
	// mode overlay networks are instantiated on a node only when there is
	// a local task attached to that network. Network is cleaned up when
	// the last task attachment to a network goes down. Network's Epoch ID
	// and the Table entry's network Epoch ID help the nodes to drop old
	// events
...
type NetworkEntry struct {
	...
	// Current Epoch ID of the network on the originating node
	EpochID uint64 `protobuf:"varint,5,opt,name=epoch_id,json=epochId,proto3" json:"epoch_id,omitempty"`
}
...
type TableEvent struct {
	...
	// Current Epoch ID of the network this table entry belongs to on the
	// originating node. Epoch ID is used associate a Table event with the
	// corresponding network instance and this allow the receiving nodes
	// to drop Table events for the older instances of the network.
	NetworkEpochID uint64 `protobuf:"varint,8,opt,name=network_epoch_id,json=networkEpochId,proto3" json:"network_epoch_id,omitempty"`
}
...
func (this *NetworkEvent) GoString() string {
	...
	s = append(s, "EpochID: "+fmt.Sprintf("%#v", this.EpochID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *TableEvent) GoString() string {
	...
	s = append(s, "NetworkEpochID: "+fmt.Sprintf("%#v", this.NetworkEpochID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *NetworkEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.EpochID != 0 {
		data[i] = 0x28
		i++
		i = encodeVarintNetworkdb(data, i, uint64(m.EpochID))
	}
	return i, nil
}
...
func (m *TableEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.NetworkEpochID != 0 {
		data[i] = 0x40
		i++
		i = encodeVarintNetworkdb(data, i, uint64(m.NetworkEpochID))
	}
	return i, nil
}
...
func (m *NetworkEvent) Size() (n int) {
	...
	if m.EpochID != 0 {
		n += 1 + sovNetworkdb(uint64(m.EpochID))
	}
	return n
}
...
func (m *TableEvent) Size() (n int) {
	...
	if m.NetworkEpochID != 0 {
		n += 1 + sovNetworkdb(uint64(m.NetworkEpochID))
	}
	return n
}
...
func (this *NetworkEvent) String() string {
	...
	s := strings.Join([]string{`&NetworkEvent{`,
		...
		`EpochID:` + fmt.Sprintf("%v", this.EpochID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TableEvent) String() string {
	...
	s := strings.Join([]string{`&TableEvent{`,
		...
		`NetworkEpochID:` + fmt.Sprintf("%v", this.NetworkEpochID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TableEvent) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetworkEpochID", wireType)
			}
			m.NetworkEpochID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.NetworkEpochID |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorNetworkdb = []byte{
	...
	,
}
