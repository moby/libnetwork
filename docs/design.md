...
Please refer to this [Docker v1.6 Design](https://github.com/docker/libnetwork/blob/master/docs/legacy.md) document for more information on networking design as of Docker v1.6.
